package spring.apitest.application;
...
import spring.apitest.exception.CCommunicationException;
...
public class KakaoService {
    ...
    public RetKakaoAuth getKakaoTokenInfo(String code) {
        ...
        params.add("redirect_uri", baseUrl + kakoRedirect);
